---
target_site: energie-reduc.com
type: guest_article
status: draft_for_review
title: Anticiper les jours rouges Tempo EDF : combien ça rapporte vraiment sur une saison ?
audience: lecteurs energie-reduc.com cherchant à réduire leur facture d'électricité
publish_url: à confirmer côté energie-reduc.com
...
Voici les leviers principaux, avec un ordre de grandeur de kWh décalables. Estimations indicatives, dépendantes de votre isolation et de vos équipements.

- **Préchauffage la veille (chauffage électrique)** : monter la consigne de 1 à 2 °C entre 22h et 6h, puis laisser redescendre. Ordre de grandeur : **5 à 15 kWh décalés** pour un T3-T4 bien isolé, jusqu'à 25 kWh pour un logement énergivore. Gain : **environ 2,75 à 8 € par jour rouge**.
- **Ballon d'eau chaude (ECS)** : forcer la chauffe en heures creuses la nuit précédente, puis couper la journée. Ballon 200 L : **6 à 10 kWh décalés**. Gain : **3 à 5 € par jour rouge**.
- **Électroménager (lave-linge, sèche-linge, lave-vaisselle)** : programmer en heures creuses (22h-6h). Environ **2 à 5 kWh** déplacés. Gain : **1 à 3 € par jour rouge**.
- **Recharge de véhicule électrique** : levier majeur. Recharger 30 kWh en heures creuses au lieu d'heures pleines un jour rouge représente **environ 16 € de gain** sur la seule recharge.

Sans véhicule électrique, un foyer qui actionne les trois premiers leviers déplace typiquement **10 à 30 kWh par jour rouge**, soit **5,50 à 16 € par journée**. Avec véhicule électrique ou pompe à chaleur, la fourchette monte sensiblement.
...
|---|---|---|---|---|
| T2 occupé en journée, chauffage électrique d'appoint | ~4 500 kWh/an | 5 à 10 kWh | 2,75 à 5,50 € | **environ 60 à 120 €** |
| T4 famille, chauffage électrique principal, ECS électrique | ~10 000 kWh/an | 15 à 30 kWh | 8 à 16,50 € | **environ 175 à 365 €** |
| Maison T5 + véhicule électrique rechargé à domicile | ~14 000 kWh/an | 35 à 60 kWh | 19 à 33 € | **environ 420 à 730 €** |
...
## Les variables qui font monter ou descendre ce chiffre

Plusieurs facteurs modulent fortement le gain réel :

- **L'inertie thermique du logement** : une maison ancienne mal isolée perd vite le préchauffage ; un logement BBC garde la chaleur 12 à 18 heures.
- **Le télétravail** : présent toute la journée, vous consommez davantage en heures pleines un jour rouge — donc plus à décaler, donc plus à gagner.
- **Le véhicule électrique** : levier le plus puissant. Une seule recharge évitée en HP rouge couvre plusieurs jours rouges de gain « ménager ».
- **La pompe à chaleur** : préchauffage très efficient, mais programmation fine requise pour ne pas annuler le gain le jour J.

## FAQ

### Les estimations tiennent-elles compte du surcoût du chauffage la veille ?
Oui, indirectement. Le calcul porte sur le **différentiel** entre kWh consommés en rouge HP et les mêmes kWh consommés en heures creuses la veille (rouge HC ou bleu HC). On compare bien deux consommations équivalentes, pas un kWh supplémentaire contre rien.

### Si je n'ai pas de chauffage électrique, est-ce que ça reste rentable ?
Oui, mais le gain est plus modeste. Vos leviers se réduisent à l'ECS, l'électroménager et la recharge éventuelle d'un véhicule. Comptez plutôt **60 à 150 € sur la saison** selon votre équipement.

### Peut-on vraiment anticiper la couleur à 5 jours ?
Pas avec une certitude absolue : la météo elle-même comporte une marge d'erreur à 5 jours. Les modèles combinant météo et consommation nationale atteignent une fiabilité élevée à J+2 et J+3, et restent indicatifs à J+4-J+5. Pour les gestes engageants (recharge de véhicule, batch-cooking), J+2-J+3 offre un niveau de confiance suffisant ; au-delà, considérez-le comme une tendance.
