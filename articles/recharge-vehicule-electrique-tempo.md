...
## Pourquoi le véhicule électrique est un cas idéal pour Tempo

La voiture électrique cumule deux atouts qui en font le compagnon parfait de l'offre Tempo : elle consomme beaucoup, et sa recharge est presque toujours décalable dans le temps.
...
La première règle, valable tous les jours de l'année, est de cantonner la recharge à la plage 22h-6h. Trois méthodes permettent d'y parvenir, de la plus simple à la plus aboutie.

### Via l'application du véhicule

La quasi-totalité des voitures électriques récentes proposent une programmation horaire dans leur application ou sur l'écran de bord. Vous définissez une heure de début (22h) et idéalement une heure de fin (6h) : la voiture ne charge qu'à l'intérieur de ce créneau, même branchée dès 19h. C'est la solution la plus accessible, sans matériel supplémentaire.

### Via la wallbox ou la borne de recharge

Une borne de recharge Tempo EDF (wallbox) dispose le plus souvent de sa propre programmation horaire, parfois pilotable via une application dédiée. Certaines bornes lisent même le contact « heures creuses » de votre compteur Linky pour ne charger que pendant la plage avantageuse. Notre article [Linky et Tempo : suivre sa consommation](/blog/linky-tempo-suivre-consommation) détaille comment exploiter ces données.

### Via une prise programmable (solution d'appoint)

Pour une recharge lente sur prise renforcée, une prise programmable ou un contacteur jour/nuit suffit à décaler la charge sur la nuit. C'est moins élégant qu'une wallbox pilotée, mais peu coûteux et efficace.

Pensez à laisser une marge : pour une grosse recharge, démarrez dès 22h afin de terminer avant 6h. Une charge de 45 kWh sur une wallbox 7,4 kW demande environ 6 heures, ce qui tient tout juste dans le créneau creux.

## Éviter les heures pleines des jours rouges

Les heures creuses règlent l'essentiel du problème. Reste le cas délicat : vous arrivez un soir de jour rouge avec une batterie presque vide et vous devez repartir tôt le lendemain. Plusieurs stratégies limitent la casse.
...
Quelques bonnes pratiques pour intégrer ces prévisions à votre routine :

- Consultez le [calendrier Tempo en temps réel](/calendrier) en début de semaine pour repérer les jours rouges probables.
- Programmez une recharge complète la nuit précédant un jour rouge annoncé.
- Inscrivez-vous aux [alertes gratuites](/#subscribe) pour recevoir une notification dès qu'un jour rouge est prévu, sans avoir à vérifier manuellement.

Rappelons que les prévisions J+2 à J+5 restent des estimations : la fiabilité décroît avec l'horizon, et seul EDF confirme la couleur définitive à J+1. Le calendrier reste donc la référence à consulter avant toute décision ferme.

## Combien économise-t-on réellement sur une saison ?
...
## FAQ : recharge du véhicule électrique avec Tempo
...
Trois options existent. La plus simple est la programmation horaire intégrée à votre voiture (application ou écran de bord) : vous définissez 22h comme heure de départ. Une wallbox ou borne de recharge Tempo EDF offre la même fonction, parfois pilotée via une application, et peut même se synchroniser sur le signal heures creuses de votre compteur Linky. Enfin, pour une recharge lente sur prise, une prise programmable ou un contacteur jour/nuit fait l'affaire. Vérifiez simplement que la durée de charge tient dans le créneau 22h-6h.
