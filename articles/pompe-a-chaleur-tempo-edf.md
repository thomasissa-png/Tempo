...
Le COP (coefficient de performance) indique combien de kilowattheures de chaleur votre PAC produit pour chaque kilowattheure électrique consommé. Un COP de 3 signifie qu'avec 1 kWh acheté, vous obtenez environ 3 kWh de chaleur dans le logement. C'est l'atout central de la pompe à chaleur : elle « divise » de fait votre consommation par rapport à un convecteur électrique classique.
...
C'est la stratégie reine pour une PAC en jour rouge, et elle repose sur l'**inertie thermique** de votre logement. Le principe : la veille d'un jour rouge, vous faites chauffer un peu plus fort pendant les heures creuses (22h-6h), quand le kWh est bon marché, pour « charger » la masse thermique du logement (chape, murs, mobilier). Le lendemain, en jour rouge, vous laissez la PAC tourner au minimum en heures pleines : le logement restitue lentement la chaleur stockée.

Cette approche fonctionne d'autant mieux que :

- votre logement est bien isolé (la chaleur ne s'échappe pas en quelques heures) ;
...
Le jour rouge lui-même, l'objectif est de minimiser la consommation entre 6h et 22h. Quelques leviers complémentaires du préchauffage :

- **Baisser la consigne** de 1 à 2 °C en journée : chaque degré en moins réduit nettement la consommation, et l'inertie du préchauffage de la veille amortit la sensation de froid.
...
Pour les foyers qui veulent sécuriser leur confort sans payer le plein tarif rouge, un **appoint** non électrique (ou très ponctuel) peut prendre le relais quelques heures pendant les heures pleines rouges : poêle à bois ou à granulés, insert, voire un point de chaleur localisé dans la pièce de vie. L'idée n'est pas de remplacer la PAC, mais de la soulager sur la poignée d'heures les plus chères de l'année.

Rappelons l'ordre de grandeur : il n'y a que 22 jours rouges par saison, soit environ 22 × 16 heures pleines à éviter. Un appoint utilisé uniquement sur ces créneaux peut donc être rentabilisé même s'il sert peu. Si vous hésitez entre Tempo et une autre option tarifaire, notre comparatif [Tempo vs heures creuses classiques](/blog/tempo-vs-heures-creuses-edf-bleu) vous aidera à trancher.

## Programmation et thermostats connectés : le vrai facilitateur

Toutes ces stratégies deviennent fastidieuses si elles reposent sur des réglages manuels quotidiens. C'est là qu'un **thermostat programmable ou connecté** change la donne. Idéalement, votre thermostat permet de :

- définir des plages horaires différenciées (consigne haute la nuit en heures creuses, consigne basse en journée) ;
...
Oui, à condition de la piloter. Voici une synthèse honnête :
...
### Faut-il couper sa pompe à chaleur les jours rouges ?

Pas nécessairement, et souvent ce n'est pas optimal. Couper totalement une PAC par grand froid puis la relancer consomme beaucoup d'énergie au moment où son COP est faible. La meilleure approche consiste généralement à **préchauffer la veille en heures creuses**, puis à **réduire** la consigne (de 1 à 2 °C) pendant les heures pleines rouges plutôt qu'à couper net.

### Le COP de ma PAC baisse-t-il vraiment les jours rouges ?

Oui, en général. Le COP diminue quand la température extérieure chute, et les jours rouges coïncident le plus souvent avec les pics de froid. L'ampleur exacte dépend du modèle et de la température, mais le phénomène est réel : c'est pourquoi ces journées méritent un pilotage spécifique. Anticipez-les grâce au [calendrier Tempo](/calendrier).
