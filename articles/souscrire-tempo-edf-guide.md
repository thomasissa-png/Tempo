...
L'option Tempo classe chaque jour de l'année dans l'une des trois couleurs, chacune avec son propre tarif :

- **Bleu** (environ 300 jours par an) : le tarif le plus avantageux, c'est tout l'intérêt de l'offre.
- **Blanc** (43 jours) : un tarif intermédiaire.
- **Rouge** (22 jours) : le tarif fort, concentré sur les pointes hivernales.
...
Souscrire Tempo EDF est intéressant si votre mode de vie permet de jouer avec les couleurs. Voici comment situer votre profil.

| Profil | Tempo est adapté ? |
|---|---|
| Chauffage alternatif disponible les jours rouges (bois, gaz, pompe à chaleur) | Oui, idéal |
| Présence flexible, capacité à décaler lessives et cuissons | Oui |
| Logement chauffé 100 % à l'électricité sans solution de repli | À éviter |
...
Avant toute démarche, vérifiez que vous remplissez les conditions techniques de base.

- **Un compteur Linky** : le suivi des couleurs et des plages horaires repose sur le compteur communicant. C'est lui qui distingue automatiquement les heures pleines des heures creuses et applique le bon tarif selon la couleur du jour. Sans Linky, l'option n'est généralement pas accessible.
- **Une puissance de compteur adaptée** : Tempo est proposé sur plusieurs puissances de compteur (exprimées en kVA). Vérifiez que la puissance souscrite couvre vos besoins, notamment si vous comptez maintenir certains usages les jours rouges. Les conditions exactes sont précisées sur le site officiel EDF.
- **Un logement compatible avec la flexibilité** : ce n'est pas une obligation technique, mais un prérequis de bon sens. Pensez à votre capacité réelle à décaler ou réduire vos usages.

Pour suivre votre consommation au fil de l'eau et vérifier que vos efforts portent leurs fruits, le compteur Linky est aussi un allié précieux : notre guide [Linky et Tempo : suivre sa consommation](/blog/linky-tempo-suivre-consommation) détaille comment exploiter ces données.
...
3. **Vérifiez la date de prise d'effet** de l'option et le moment où la nouvelle grille tarifaire s'applique.
4. **Conservez vos identifiants d'espace client** : c'est là que vous suivrez votre consommation et vos factures.

Aucune coupure d'électricité n'est nécessaire pour activer Tempo sur un compteur Linky : le changement est piloté à distance. Pour les détails pratiques et les conditions à jour, référez-vous toujours au site officiel EDF.

## Ce qui change après la souscription
...
Sur ce site, vous trouvez en permanence le [calendrier Tempo à jour](/calendrier) avec les couleurs passées (officielles EDF) et les prévisions à venir. Et comme EDF ne communique que le lendemain (J+1), notre système va plus loin : il **prédit les couleurs de J+2 à J+5**, ce qui vous laisse plusieurs jours pour vous organiser.

## Bien démarrer : anticiper les jours rouges

Les premières semaines sont décisives pour prendre les bons réflexes. Voici comment partir du bon pied.
...
### Faut-il obligatoirement un compteur Linky pour souscrire à Tempo ?

Oui, dans la grande majorité des cas. Le compteur Linky est nécessaire pour distinguer automatiquement les heures pleines et heures creuses et appliquer le tarif correspondant à la couleur du jour. C'est aussi grâce à lui que vous pouvez suivre votre consommation en détail. Vérifiez les conditions exactes d'éligibilité sur le site officiel EDF.
