...
## Les différentes façons de recevoir une alerte jour rouge Tempo

### L'application EDF & Moi

EDF propose sa propre application mobile, EDF & Moi, qui peut envoyer des notifications push pour les jours Tempo. L'avantage est qu'il s'agit de la source officielle. Les inconvénients sont nombreux : il faut installer l'application, créer un compte, activer les notifications, et s'assurer que le téléphone ne les bloque pas en mode silencieux. De plus, les notifications push sont souvent noyées parmi des dizaines d'autres et facilement ignorées.

### Les applications tierces et widgets
...
L'inscription est volontairement minimaliste. Voici comment procéder :

**1. Rendez-vous sur la page d'inscription**

Accédez à [calendrier-tempo.fr](/) et descendez jusqu'à la section "Recevez un WhatsApp avant chaque jour cher", ou cliquez directement sur le bouton [S'inscrire maintenant](/#subscribe) présent en haut de la page.
...
Cliquez sur "M'inscrire gratuitement". Vous recevrez un message WhatsApp de confirmation. A partir de ce moment, vous serez alerté automatiquement avant chaque jour rouge.

Pas de mot de passe à retenir, pas de compte à créer, pas d'application à télécharger. Toute la configuration se fait en une seule page.

## Que contiennent les alertes Tempo WhatsApp ?

### Le message type que vous recevez
...
La distinction entre couleur confirmée par EDF et prévision est toujours clairement indiquée. Quand nous anticipons un jour rouge plusieurs jours à l'avance, vous le savez et pouvez commencer à vous organiser. Quand EDF confirme officiellement, vous recevez la confirmation définitive.

## Personnalisez vos alertes selon vos besoins

### Choisissez les jours qui déclenchent une alerte
...
Chaque dimanche en fin de journée, les abonnés reçoivent un **récapitulatif de la semaine à venir**. Ce message résume les prévisions pour les sept prochains jours : combien de jours rouges et blancs sont attendus, quelles dates exactes, et quel est le niveau de confiance de chaque prévision.

Ce récapitulatif vous permet de planifier votre semaine entière : programmer les lessives les jours bleus, prévoir du bois de chauffage pour les jours rouges, organiser la recharge de votre véhicule électrique sur les bonnes nuits. C'est un outil de planification que les abonnés apprécient particulièrement.

## Comparaison des services d'alerte Tempo disponibles

| Critère | EDF & Moi | Applications tierces | calendrier-tempo.fr |
|---------|-----------|---------------------|---------------------|
