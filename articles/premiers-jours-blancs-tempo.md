...
L'offre Tempo d'EDF fait varier le prix de l'électricité chaque jour selon trois couleurs. Le jour blanc occupe la position intermédiaire : il est **plus cher que le jour bleu, mais bien moins cher que le jour rouge**.
...
Pour bien gérer son budget, il faut visualiser clairement la hiérarchie des trois couleurs. Voici un tableau comparatif synthétique.

| Couleur | Niveau de prix | Fréquence/saison | Quand ? | Restrictions calendaires |
|---------|----------------|------------------|---------|--------------------------|
...
- **Un jour bleu**, vous consommez librement, sans vous poser de questions.
- **Un jour blanc**, vous avez tout intérêt à décaler les gros postes (lave-linge, lave-vaisselle, chauffe-eau) vers les heures creuses, mais sans bouleverser votre quotidien. L'écart de prix reste modéré.
- **Un jour rouge**, c'est la vigilance maximale : on coupe, on reporte, on chauffe le strict nécessaire en heures pleines.

Autrement dit, le jour blanc demande un **réflexe d'optimisation léger**, là où le jour rouge impose une véritable discipline. Le négliger totalement reste une erreur : sur 43 journées, les petits surcoûts s'additionnent.
...
La bonne nouvelle, c'est que les bons gestes pour les jours blancs sont les mêmes que pour les jours rouges, en version plus souple. Voici nos conseils concrets.

1. **Décalez les appareils énergivores en heures creuses (22h-6h)** : lave-linge, sèche-linge, lave-vaisselle, chauffe-eau, recharge de véhicule électrique. C'est le geste le plus rentable, même un jour blanc.
2. **Modérez le chauffage en heures pleines** : inutile de grelotter, mais baisser la consigne de 1 à 2°C suffit à lisser le surcoût. Nos [astuces chauffage spéciales jours chers](/blog/chauffage-jour-rouge-tempo-astuces) s'appliquent aussi aux jours blancs.
3. **Gardez le réflexe de vérifier la couleur** : un coup d'œil quotidien suffit à éviter les mauvaises surprises.
...
Non pour le dimanche : la **règle R3 interdit formellement les jours blancs le dimanche**, qui reste donc systématiquement un jour bleu. En revanche, contrairement au jour rouge (interdit tout le week-end par la règle R2), un jour blanc **peut tout à fait tomber un samedi**. Il n'est donc pas rare de voir une journée blanche en plein week-end, hors dimanche.
